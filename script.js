var juego=new Phaser.Game(1148,785,Phaser.CANVAS,'escenario');
var fondoJuego;
var persona;
var teclaDerecha;
var teclaIzquierda;
...
var estadoPrincipal={
	...
	preload: function(){
		...
		juego.load.spritesheet('animacion','img/character2Spritesheet.png',256,256);//lado x lado del enemigo
		juego.load.spritesheet('enemigo', 'img/character1Spritesheet.png',256,256); //lado x lado del enemigo
	...
	create: function(){
		...
		fondoJuego=juego.add.tileSprite(0,0,1148,785,'fondo');
		//----------PERSONAJE-------------------
